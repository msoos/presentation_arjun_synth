...
\node[sB, below=of s3] (s4)
 {\textbf{3. Unate / definition probe} {\tiny (\texttt{--unatedef}, on by default; \texttt{unate\_def.cpp})}\\
...
\begin{frame}{Takeaways}
  \begin{itemize}\setlength{\itemsep}{2pt}
    ...
    \item Arjun synthesises Boolean functions on a Puura-simplified
          CNF: input / to-define / backward-defined is the key data
          model
    ...
    \item Obviously available for every system you can dream of:
